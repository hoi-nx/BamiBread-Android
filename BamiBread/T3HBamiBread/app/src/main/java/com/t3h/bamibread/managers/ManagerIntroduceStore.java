...
public class ManagerIntroduceStore {
    private static ManagerIntroduceStore managerIntroduceStore;

    private static final String TAG=ManagerIntroduceStore.class.getSimpleName();


    public static ManagerIntroduceStore getInstance(){
        if(managerIntroduceStore==null){
            managerIntroduceStore=new ManagerIntroduceStore();
        }
        return managerIntroduceStore;
    }
