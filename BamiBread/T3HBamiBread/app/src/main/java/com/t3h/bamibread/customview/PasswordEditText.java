...
public class PasswordEditText extends AppCompatEditText {
    ...
    private boolean useValidate;
    public static final int ALPHA = (int) (255 * .50f);

    private static final String REX="((?=.*\\d)(?=.*[A-Z])(?=.*[a-z]).{6,20})";
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            useValidate=typedArray.getBoolean(R.styleable.PasswordEditText_useValidate,false);
            typedArray.recycle();
        }
